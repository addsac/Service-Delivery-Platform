...
export default function Topbar() {
  ...
  return (
    <div className='fixed w-[calc(100%-300px)] pt-10 pb-8 flex-center bg-slate-50 border-b border-slate-900/5'>
        <GridContainer className='w-full flex items-center justify-between h-8'>
            <p className="text-md text-slate-500"> Sito web dello studio del Dr. Caron </p>
